...
/**
 * Marshalls operationSelector Models.
 */
public class V1OperationSelectorMarshaller extends BaseMarshaller {
     ...
     */
    public V1OperationSelectorMarshaller(Descriptor desc) {
        super(desc);
    }
