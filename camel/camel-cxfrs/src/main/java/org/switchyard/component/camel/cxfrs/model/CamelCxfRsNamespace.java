...
/**
 * A Camel CxfRs config model namespace.
 */
public enum CamelCxfRsNamespace implements Namespace {
    ...
    /**
     * Constructs a new CamelCxfRsNamespace with the specified version.
     * @param version the specified version, or null to discover the default
     */
    CamelCxfRsNamespace(String version) {
    ...
    /**
     * Gets the CamelCxfRsNamespace for the specified uri, or null if no matching uris are found.
     * @param uri the uri
     * @return the CamelCxfRsNamespace
     */
    public static CamelCxfRsNamespace fromUri(String uri) {
        return Util.fromUri(CamelCxfRsNamespace.class, uri);
    }
    ...
    private static final class Util extends Namespace.Util {
        ...
        private static final Descriptor DESCRIPTOR = new Descriptor(CamelCxfRsNamespace.class);
        private Util(String version) {
            super(DESCRIPTOR, "urn:switchyard-component-camel-cxfrs:config", version);
        }
    }
